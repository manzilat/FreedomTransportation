namespace FreedomTransportation.Migrations
{
    ...
    public partial class madechangesinmodels : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        lat = c.String(),
                        lng = c.String(),
                        CustomerWalletId = c.Int(nullable: false),
                        SchedulingRideId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CustomerWallets", t => t.CustomerWalletId, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        DipartureTime = c.DateTime(nullable: false),
